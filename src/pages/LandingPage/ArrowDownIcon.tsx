...
const ArrowDownIcon: React.FC<ArrowDownIconProps> = ({ darkMode }) => {
  const fillColor = darkMode ? '#fff' : '#000';

  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" className="w-10 transition-all animate-bounce hover:animate-none">
      <g>
