  ...
  return (
    <Layout>
      <div className="grid place-items-center lg:mt-32 mt-20 px-52">
        ...
        {/* Aquí usamos el componente SearchBar y pasamos la función de devolución de llamada */}
        ...
        <div className="grid grid-cols-3 gap-16 mt-14 mr-10 mb-5">
          {loading ? (
            ...
            response.map((info, index) => (
              <LayoutCard key={index} layout={info} />
            ))
          )}
        </div>
        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-16 mt-14 mr-10 mb-5"></div>
      </div>
    </Layout>
  );
}
